...
void loop(void) {
  ...
  float tempProbe0;
  tempProbe0 = thermAverage0 / THERM_OHMS;        // (R/Ro)
  tempProbe0 = log(tempProbe0);                   // ln(R/Ro)
  tempProbe0 /= BCOEFFICIENT;                     // 1/B * ln(R/Ro)
  tempProbe0 += 1.0 / (THERM_TEMP + 273.15);      // + (1/To)
  tempProbe0 = 1.0 / tempProbe0;                  // Invert
  tempProbe0 -= 273.15;                           // convert to C
  ...
  float tempProbe1;
  tempProbe1 = thermAverage1 / THERM_OHMS;        // (R/Ro)
  tempProbe1 = log(tempProbe1);                   // ln(R/Ro)
  tempProbe1 /= BCOEFFICIENT;                     // 1/B * ln(R/Ro)
  tempProbe1 += 1.0 / (THERM_TEMP + 273.15);      // + (1/To)
